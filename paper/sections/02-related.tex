...
calculus --- is the opening \pla{} targets (and, under the drift designs
of Section~\ref{sec:evaluation}, ultimately reports a negative on), and
it connects to the concept-drift literature~\cite{gama2014}, where
adaptation is studied outside logical representations. Bayesian networks (e.g.\ the
...
equal-interpretability baselines in Section~\ref{sec:evaluation}.
