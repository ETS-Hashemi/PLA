...
marginal does not exist in general --- overlapping proofs are
reconciled by inclusion--exclusion, which does not split into per-rule
shares without attribution machinery (and assumptions) of its own.
