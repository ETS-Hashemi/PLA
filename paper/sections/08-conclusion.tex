...
readable rules $0.01$--$0.03$ below the interpretable accuracy frontier
on credit-card fraud across three split seeds, with near-perfect
calibration and traces whose fidelity beats a control on every dataset
--- and a pre-registered
negative on the context-conditioning mechanism itself, whose ablations
show no reliable ranking benefit under any of three designs. The
